...
export default function LeadCapture() {
  ...
  return (
    <div className="container" style={{ paddingTop: 56, paddingBottom: 40, maxWidth: 480 }}>
      ...
      <p>Just your name and email — no password, no account needed.</p>
      ...
      <p style={{ marginTop: 16, fontSize: 14, textAlign: 'center' }}>
        Want your full result saved with strengths + course outline?{' '}
        <Link to="/signup">Sign up free</Link> instead.
      </p>
    </div>
  );
}
